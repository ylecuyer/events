...
ActiveRecord::Schema.define(version: 20170630170657) do
  ...
  create_table "logs", id: :serial, force: :cascade do |t|
    ...
    t.index ["attendee_id"], name: "index_logs_on_attendee_id"
  end
  ...
  add_foreign_key "attendees", "categories"
  add_foreign_key "attendees", "events"
  add_foreign_key "categories", "events"
  add_foreign_key "logs", "attendees"
end
